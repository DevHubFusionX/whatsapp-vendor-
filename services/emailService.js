...
const sendOTPEmail = async (email, otp, name) => {
  const mailOptions = {
    ...
    to: email,
    subject: 'Verify Your Email - Vendor Platform',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
          <h1 style="color: #10b981; margin: 0;">Vendor Platform</h1>
        ...
        <div style="background: #f9fafb; padding: 30px; border-radius: 12px; margin-bottom: 20px;">
          ...
          <p style="color: #4b5563; line-height: 1.6;">
            Welcome to our vendor platform! Please verify your email address using the code below:
          </p>
